...
```
## Reminder to self:
- bring white board markers & cable
- change back to default white layout
- larger font size
- url to data on the board
- turn off notifications & sound
...
We will be live coding so feel free to follow along!
...
## Download your data
1. go to: 
https://github.com/UBC-R-Study-group/introRworkshop_Sept19
shortened link - https://tinyurl.com/y2qfb2pk
2. click the green button
3. save it somewhere you can access later (we will be using this in the next topic)
...
- workflow is usually: (1) type your code out in R script
...
try loking at the help documentation for one of the functions we have used so far - ie. `sum()`
